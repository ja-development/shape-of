...
(a=[a]);a.forEach(function(h){h=h.split(".");"shapeOf"===h[0]&&2===h.length&&(shapeOf[h[1]]=c,shapeOf.optional[h[1]]=g)})})})();shapeOf._versionCompatibilityHistory={"0.0.7":"0.0.7","0.0.6":"0.0.6","0.0.5":"0.0.5"};shapeOf.version="0.0.7";shapeOf.compatibleSchemaVersion="0.0.7";module.exports=shapeOf;